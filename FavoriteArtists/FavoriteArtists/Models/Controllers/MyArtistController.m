...
@implementation MyArtistController
...
- (void)fetchArtistsWithName:(NSString *)name completion:(ArtistFetchCompletionHandler)completion {
    ...
    NSURLSessionTask *task = [NSURLSession.sharedSession dataTaskWithURL:url completionHandler:^(NSData *_Nullable data, NSURLResponse *_Nullable response, NSError *_Nullable error) {
        ...
        MyArtist *artistResults = [[MyArtist alloc] initWithDictionary:artist];
...
- (NSArray *)fetchSavedArtists {
    ...
    for (NSString *artist in filePath) {
        ...
        MyArtist *artist = [[MyArtist alloc] initWithDictionary:artistDictionary];
